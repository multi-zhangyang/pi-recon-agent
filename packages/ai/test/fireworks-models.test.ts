...
import { registerFireworksFixtures } from "./model-fixtures.ts";

registerFireworksFixtures();
...
describe("Fireworks models", () => {
	it("registers the default Kimi K2.6 model via Anthropic-compatible Messages API", () => {
		const model = getModel<"anthropic-messages">("fireworks", "accounts/fireworks/models/kimi-k2p6")!;
