...
REPI is organized around executable reverse/pentest workflows: passive mapping first, runtime proof before broad claims, evidence-ledger writeback, bounded context compaction, and checkpoint-backed capability claims.
