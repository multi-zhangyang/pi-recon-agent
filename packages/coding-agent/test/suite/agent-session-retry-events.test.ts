...
import { fauxAssistantMessage, fauxThinking, fauxToolCall } from "@pi-recon/repi-ai";
...
describe("AgentSession retry and event characterization", () => {
	...
	it("retries an OpenAI Responses stream that ends before a terminal event", async () => {
