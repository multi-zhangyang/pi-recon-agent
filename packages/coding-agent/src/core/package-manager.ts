...
// Keep this public helper available from the package-manager entry point.
export { getExtensionTempFolder };
...
function isOfflineModeEnabled(): boolean {
	const value = process.env.REPI_OFFLINE ?? process.env.PI_OFFLINE;
...
export class DefaultPackageManager implements PackageManager {
	...
	private getNpmInstallArgs(specs: string[], installRoot: string): string[] {
		...
		// @pi-recon/repi-* peers. Stale auto-installed pi peers can otherwise block updates.
	...
	private addAutoDiscoveredResources(
		...
		// User extensions from ~/.repi/agent/
		addResources(
			"extensions",
