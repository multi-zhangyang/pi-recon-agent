...
const OpenAICompletionsCompatSchema = Type.Object({
	...
	deferredToolsMode: Type.Optional(Type.Literal("system-message")),
...
const ProviderHeaderValueSchema = Type.Union([Type.String(), Type.Null()]);
const InputModalitiesSchema = Type.Array(Type.Union([Type.Literal("text"), Type.Literal("image")]), {
	minItems: 1,
	uniqueItems: true,
});
...
const ModelCostTierSchema = Type.Object({
	...
	inputTokensAbove: NonNegativeIntegerSchema,
});
...
const ModelDefinitionSchema = Type.Object({
	...
	headers: Type.Optional(Type.Record(Type.String(), ProviderHeaderValueSchema)),
...
export function formatModelConfigValidationPath(error: TLocalizedValidationError): string {
