...
const MIGRATION_GUIDE_URL =
	"https://github.com/multi-zhangyang/pi-recon-agent/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.repi/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.repi/agent/ instead of
 * ~/.repi/agent/sessions/<encoded-cwd>/. This migration moves them
 ...
 * Note: tools/ may contain fd/rg binaries extracted by repi, so only warn if it has other files.
 */
