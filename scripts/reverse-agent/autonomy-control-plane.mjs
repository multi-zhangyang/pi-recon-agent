...
const REQUIREMENTS = [
	...
	},
	{
		...
		recommendedWork: [
			...
			"保持 agent-dogfood failure signature binding，并继续扩展到 re_swarm/provider worker live artifacts。",
