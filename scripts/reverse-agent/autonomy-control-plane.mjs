...
function buildManifest(root) {
	...
	return {
		...
		topAutonomousDefinitionReason: "核心组织链路、ContextPackV2 exact resume marker 和控制面字段/validator 可用，但独立子会话 runtime、exact resume 负例/closure gate、统一失败账本运行时写入和 claim-level runtime 合成仍需硬化。",
		pillars,
