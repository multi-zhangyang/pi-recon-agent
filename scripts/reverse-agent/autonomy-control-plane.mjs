...
const REQUIREMENTS = [
	{
		...
		hardeningNeeded: [
			...
			"把 re_swarm 的 command-level worker packet 从 strict contract fixture 推进到可选 live 独立 Pi agent/session runtime。",
		],
		recommendedWork: [
	...
	},
	{
		...
		recommendedWork: [
			...
			"继续把同一 ledger schema 接入 strict validator regression 和通用 re_swarm 独立 sub-agent/session runtime。",
