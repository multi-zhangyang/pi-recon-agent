...
const REQUIREMENTS = [
	...
	},
	{
		...
		hardeningNeeded: [
			...
			"Memory v6 Orchestrator 已把 pre-task retrieve、scope-safe inject、post-tool writeback、compact hooks、final supervise 接入 gate；后续继续补真实远程 embedding live 回归、更多 latest-artifact consumers 的 side-channel scope 压力回归和 re_swarm 多进程 worker memory writeback 压力回归。",
		],
		recommendedWork: [
