...
const HARDENING_GAP_CATALOG = [
	{
		...
		currentEvidence: ["gate:swarm-provider-manifest-parity", "gate:worker-child-session", "gate:parallel-provider-worker-matrix", "gate:worker-lease-scheduler", "SwarmProviderSharedMergeLedgerV1", "SwarmProviderRetryRepairBindingV1", "LiveProviderBackedSharedLedgerMatrixV1", "ProviderWorkerRetryWindowManifestBindingChainV1", "ProviderBackedLongWindowSharedMergeLedgerV1", "ProviderWorkerExtendedRetryManifestChainV1"],
