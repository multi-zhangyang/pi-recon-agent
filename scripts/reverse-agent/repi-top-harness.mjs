...
function staticContractChecks() {
	...
	checks.push(markerCheck("parallel:swarm-provider-manifest-parity-hard-eval", "scripts/reverse-agent/swarm-provider-manifest-parity-gate.mjs", ["repi-swarm-provider-manifest-parity-gate", "SwarmProviderManifestParityGateV1", "fixture:positive-parity", "fixture:negative-parity"], []));
	checks.push(markerCheck("parallel:swarm-provider-manifest-parity-schema", "schemas/reverse-agent/swarm-provider-manifest-parity.schema.json", ["SwarmProviderManifestParityGateV1", "provider_env_refs_only", "failure_repair_refs_preserved_across_provider_worker"], []));
	checks.push(markerCheck("parallel:swarm-provider-manifest-parity-fixture", "fixtures/reverse-agent/swarm-provider-manifest-parity.fixture.json", ["repi-swarm-provider-manifest-parity-fixture", "worker-id-mismatch", "literal-provider-secret", "failure-repair-unlinked"], []));
	...
	checks.push(markerCheck("provider:runtime-matrix-hard-eval", "scripts/reverse-agent/provider-runtime-matrix-gate.mjs", ["repi-provider-runtime-matrix-gate", "ProviderRuntimeMatrixV1", "runtime:provider-matrix-openai-completions", "runtime:provider-matrix-anthropic-messages", "runtime:provider-matrix-env-ref-only", "negative:missing-env-ref"], []));
	...
	checks.push(markerCheck("claims:live-conflict-arbitration-matrix-hard-eval", "scripts/reverse-agent/live-conflict-arbitration-matrix-gate.mjs", ["repi-live-conflict-arbitration-matrix-gate", "LiveConflictArbitrationMatrixGateV1", "runtime:source-coverage-all-runtimes", "runtime:orchestration-platform-split", "fixture:negative-rejections"], []));
	checks.push(markerCheck("claims:live-conflict-arbitration-matrix-schema", "schemas/reverse-agent/live-conflict-arbitration-matrix.schema.json", ["LiveConflictArbitrationMatrixGateV1", "source_coverage_all_runtimes", "winner_evidence_json_query_verifier", "orchestration_success_separate_from_platform_claim"], []));
	checks.push(markerCheck("claims:live-conflict-arbitration-matrix-fixture", "fixtures/reverse-agent/live-conflict-arbitration-matrix.fixture.json", ["repi-live-conflict-arbitration-matrix-fixture", "missing-winner-evidence", "loser-promoted", "orchestration-implies-platform-pass"], []));
	...
	checks.push(markerCheck("compact:cross-session-multi-compact-matrix-hard-eval", "scripts/reverse-agent/cross-session-multi-compact-matrix-gate.mjs", ["repi-cross-session-multi-compact-matrix-gate", "CrossSessionMultiCompactMatrixGateV1", "runtime:old-context-path-over-latest-after-multiple-compacts", "runtime:provider-continuation-after-exact-resume", "fixture:negative-rejections"], []));
	checks.push(markerCheck("compact:cross-session-multi-compact-matrix-schema", "schemas/reverse-agent/cross-session-multi-compact-matrix.schema.json", ["CrossSessionMultiCompactMatrixGateV1", "cross_session_multi_compact_same_run", "provider_continuation_after_exact_resume", "terminal_resume_rows_not_reopened"], []));
	checks.push(markerCheck("compact:cross-session-multi-compact-matrix-fixture", "fixtures/reverse-agent/cross-session-multi-compact-matrix.fixture.json", ["repi-cross-session-multi-compact-matrix-fixture", "latest-fallback-without-explicit-context", "provider-continuation-missing", "terminal-row-reopened"], []));
