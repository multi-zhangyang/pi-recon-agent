...
function staticContractChecks() {
	...
	checks.push(markerCheck("npm:top-harness-script", "package.json", ["gate:repi-harness", "gate:repi-product", "gate:repi-isolation", "gate:repi-product-surface", "gate:context-compact", "gate:compact-resume-chain", "gate:memory-contract", "gate:memory-utility", "gate:memory-feedback", "gate:memory-hybrid", "gate:memory-usefulness", "gate:memory-distiller", "gate:memory-sedimentation", "gate:memory-store", "gate:worker-runtime-pool", "gate:worker-child-session", "gate:structured-claim-merge", "install:repi", "clean:repi-legacy-profile"], ["install:recon-pi", "gate:pi-recon-primary"]));
	...
	checks.push(markerCheck("memory:usefulness-hard-eval", "scripts/reverse-agent/memory-usefulness-gate.mjs", ["repi-memory-usefulness-gate", "eval:hit-at-1", "eval:forbidden-leak", "concurrency:hash-chain"], []));
	checks.push(markerCheck("memory:usefulness-fixture", "fixtures/reverse-agent/memory-usefulness.fixture.json", ["repi-memory-usefulness-fixture", "authz-bola-recall", "pwn-crash-recall", "concurrentAppend"], []));
	...
	checks.push(markerCheck("compact:resume-chain-fixture", "fixtures/reverse-agent/compact-resume-chain.fixture.json", ["repi-compact-resume-chain-fixture", "resumeTransitions", "autoResumeTelemetry", "negativeCases", "compact_resume_success_skip_low_value_lane"], []));
