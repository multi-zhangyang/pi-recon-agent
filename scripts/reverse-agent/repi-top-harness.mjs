...
function staticContractChecks() {
	...
	checks.push(markerCheck("npm:top-harness-script", "package.json", ["gate:repi-harness", "gate:repi-product", "gate:repi-isolation", "gate:repi-product-surface", "gate:context-compact", "gate:compact-resume-chain", "gate:compact-resume-ledger-v2", "gate:cross-session-resume-live", "gate:context-runtime-schema", "gate:memory-contract", "gate:memory-utility", "gate:memory-feedback", "gate:memory-feedback-closure", "gate:memory-scope-isolation", "gate:knowledge-scope-isolation", "gate:artifact-scope-filter", "gate:memory-orchestrator", "gate:memory-deposition", "gate:memory-experience", "gate:memory-quality-ledger", "gate:memory-replay-evaluator", "gate:memory-strategy-capsule", "gate:memory-active-kernel", "gate:memory-maturation-runtime", "gate:memory-ux", "gate:memory-hybrid", "gate:memory-vector", "gate:memory-usefulness", "gate:memory-distiller", "gate:memory-sedimentation", "gate:memory-store", "gate:memory-swarm-writeback", "gate:memory-supervisor", "gate:worker-runtime-pool", "gate:worker-lease-scheduler", "gate:worker-child-session", "gate:provider-runtime-matrix", "gate:provider-failure-injection", "gate:repair-rollback-policy", "gate:tool-call-trace-ledger", "gate:parallel-provider-worker-matrix", "gate:remote-provider-longrun", "gate:structured-claim-merge", "install:repi", "clean:repi-legacy-profile"], ["install:recon-pi", "gate:pi-recon-primary"]));
