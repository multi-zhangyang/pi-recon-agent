...
- `reverse_capability_guards` 必须保留 re_native_runtime、re_web_authz_state、re_mobile_runtime、re_exploit_lab、re_proof_loop、re_autopilot、re_knowledge_graph、compact_resume_case_memory、operator_command_floor、proof_exit_criteria 和 specialist_runtime_planner 等逆向/渗透能力标记，防止 profile check 优化削弱专业能力。
