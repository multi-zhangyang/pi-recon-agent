...
当前 ledger 覆盖四类顶级 harness 后续闭合项：re_swarm/provider worker manifest parity、cross-session multi-compact live matrix、provider/worker repair rollback unification、live conflict arbitration matrix。
