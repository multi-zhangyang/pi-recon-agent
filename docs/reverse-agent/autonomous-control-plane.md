...
- 继续扩大 structured claim conflict table 样本，不再只靠文本摘要；final promotion 走 `StructuredClaimMergeV1` / `AgentDogfoodStructuredClaimMergeGateV1` gate。
