...
function normalizedPlanSummary() {
  return {
    ...
    target: loadedParallelPlan?.target || 'REPI parallel dogfood',
    validation: parallelPlanValidation,
...
const md = [
  '# REPI Parallel Agent Dogfood Artifact',
  '',
  `verdict: ${verdict}`,
  `provider: ${provider}`,
  `model: ${model}`,
